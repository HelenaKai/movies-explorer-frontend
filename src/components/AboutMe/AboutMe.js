      ...
      <div className="about-me__container">
        <div className="about-me__content">
          ...
          <p className="about-me__description">
            Я родилась в Санкт-Петербурге, закончила СПБГУПТД, кафедру ИиУС. Мне
            нравиться работать над интересными проектами заказчиков, делая их с
            помощью издательских и графических программ. Теперь реализую себя в
